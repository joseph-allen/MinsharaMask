...
REMOVE
It should summarize the topic area of the report, the main achievements, the results and the conclusions. Note, the focus of the abstract is the contents of the report and not the project.
\end{abstract}
...
What is Image Processing? Where does this project fit in Image Processing. Why am I doing this? What do I hope to Achieve? REMOVE.
...
There were two main requirements going into this project, the personal requirement was needing some long-term product I could work towards producing. For my Client the requirement was that she had some sort of fun tool she could use.
...
The Project is made available on a public Github repository\cite{GITHUB}, I choose this because one of the aims of the project is to help artists become more like programmers so an early exposure to Git useful. The project is Open Source and Github has an excellent interface for dealing with Open Source pull requests again making Github a good choice for distribution. A downside is that there are easier methods of distribution so I am hoping that it is trivial enough to download a ZIP file from Github itself, I tried to get around this by making the ReadMe file as obvious as possible. I could have written the project in p5.js which allows the project to run in browser, however I wasn't sure Javescript was the right choice for an Image Processing project and this distribution would not encourage the artists to look into the code themselves.

\subsection{Learning}
In order to encourage the curiosity and mastery stages of the project I attempt to remove all difficulties of setting up the project and get the source code into the hands of the artists as simply as possible.
...
The purpose of these videos is to relieve the pain points of getting the project, these are the following:
